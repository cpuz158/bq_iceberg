...
3. **`external_iceberg_weblog`**: Lakehouse External Iceberg Table (Lakehouse Runtime Catalog `bl://projects/PROJECT_ID/catalogs/lakehouse_runtime_catalog` & PyIceberg)
